 ...
 */
package org.praxalogic.util.job.management.sample;

import java.util.concurrent.ArrayBlockingQueue;
import java.util.concurrent.ThreadPoolExecutor;
import java.util.concurrent.TimeUnit;

import org.praxalogic.util.job.Job;
import org.praxalogic.util.job.JobContext;
import org.praxalogic.util.job.PassThruTask;
import org.praxalogic.util.job.Task;
import org.praxalogic.util.job.management.JobManager;
import org.praxalogic.util.job.management.JobManager.ThreadCommand;
